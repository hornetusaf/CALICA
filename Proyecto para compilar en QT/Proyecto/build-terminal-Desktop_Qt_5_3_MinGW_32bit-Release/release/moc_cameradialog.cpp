...
#include "../../terminal/cameradialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_cameradialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 34, 0)
    ...
    "cameradialog\0on_dirButton_clicked\0"
};
...
const QMetaObject cameradialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_cameradialog.data,
      qt_meta_data_cameradialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_cameradialog.stringdata))
