...
void SettingsDialog::showPortInfo(int idx)
{
    if (idx != -1) {
        ...
        ui->descriptionLabel->setText(tr("Descripción: %1").arg(list.at(1)));
        ui->manufacturerLabel->setText(tr("Fabricante: %1").arg(list.at(2)));
        ui->locationLabel->setText(tr("Ubicación: %1").arg(list.at(3)));
        ui->vidLabel->setText(tr("Vendedor Id: %1").arg(list.at(4)));
        ui->pidLabel->setText(tr("Producto Id: %1").arg(list.at(5)));
    }
}
